...
namespace std {
    ...
    %ignore vector<Distance>::vector(size_type);
    %ignore vector<Distance>::resize;
    %template(DistanceVector) vector<Distance>;
}
...
void add_symmetry(std::vector<Distance>& distances);
